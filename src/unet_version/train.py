    ...
    def UNet(self):
        ...
        if self.mode == 'train':
            if self.train_continue == "on":
                net, optim = load_model(ckpt_dir=self.ckpt_dir, net=net, optim=optimizer)
            ...
            for epoch in range(1, self.num_epoch + 1):
                ...
                if epoch % 50 == 0:
                    save_model(ckpt_dir=self.ckpt_dir, net=net, optim=optimizer, epoch=epoch)
        ...
        # TEST MODE
            ...
            net, optim, st_epoch = load(ckpt_dir=self.ckpt_dir, net=net, optim=optimizer)
